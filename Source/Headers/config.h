...
#define CAMS_NC_FILENAME (char*)"/data90t/geosci/spetrov/nc_topaz/atm-forcing-2019-rev.nc"
...
#define SCALE_FACTOR_NAME "scale_factor"

// Invalid value name TOPAZ
#define INVALID_VALUE_NAME "missing_value"

// Offset name TOPAZ
#define OFFSET_NAME "add_offset"
...
#define UA_NAME_CAMS "u10"
#define VA_NAME_CAMS "v10"
