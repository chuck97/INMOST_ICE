...
bool operator!=(const Spherical_Coords<RealType>& lhs, const Spherical_Coords<RealType>& rhs)
{
  return ((lhs.Get_x() != rhs.Get_x()) or (lhs.Get_y() != rhs.Get_y()));
}

template<typename RealType>
Spherical_Coords<RealType> operator+(const Spherical_Coords<RealType>& lhs, const Spherical_Coords<RealType>& rhs)
{
