...
/* M */ f77i*, f77i*, f77i*, f77r*, f77i*, f77i*, 
        f77i*, f77i*, f77i*, f77i*, f77i*, f77i*,
        f77i*,               f77r*, f77i*, void (*crvfunc)(double*, double*, int*), 
        f77i*, f77i*, f77i*, f77i*, f77i*, f77i*,
/* CONTROL */  
        f77i*, f77r*, f77i*, int (*metric)(double*, double*, double*), 
...
int ani2D_analytic(ani2D* ani, int (*metric)(double*, double*, double*), void (*crvfunc)(double*, double*, int*));
int ani2D_nodal(ani2D* ani, double* metric, void (*crvfunc)(double*, double*, int*));
